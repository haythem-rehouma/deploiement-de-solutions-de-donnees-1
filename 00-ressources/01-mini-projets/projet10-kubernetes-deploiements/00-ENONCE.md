...
> *(Alternatives possibles : `minikube start` ou `kind create cluster`. Le projet fonctionne aussi, moyennant le chargement de l'image — voir [02-COMMANDES.md](02-COMMANDES.md).)*
...
> Bloqué ? Le **[README.md](README.md)** contient le **corrigé complet** (manifestes commentés + commandes), et l'**[aide-mémoire des commandes](02-COMMANDES.md)** liste tout `kubectl` utile — à consulter **après** avoir essayé.
