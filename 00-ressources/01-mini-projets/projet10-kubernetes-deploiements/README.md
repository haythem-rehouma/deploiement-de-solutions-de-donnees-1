...
>
> Pressé ? Voir l'**[aide-mémoire des commandes](02-COMMANDES.md)**.
...
> Docker Desktop propose deux types de cluster (**kind** ou **Kubeadm**) : voir le comparatif **[kind vs Kubeadm](01-CLUSTER-KIND-VS-KUBEADM.md)**. Pour ce projet, choisissez **Kubeadm**.
...
├── 01-CLUSTER-KIND-VS-KUBEADM.md   # kind vs Kubeadm (choix du cluster)
...
```powershell
# 0) Kubernetes activé dans Docker Desktop (voir 02-COMMANDES.md §0)
...
> Toutes les commandes détaillées (exec, logs, port-forward, minikube/kind, dépannage) sont dans **[02-COMMANDES.md](02-COMMANDES.md)**.
